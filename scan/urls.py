...
urlpatterns = [
    ...
    url(r'^site/deletesite/$', views.deletesite, name='deletesite'),
    url(r'^site/defaultsite/$', views.defaultsite, name='defaultsite'),
    url(r'^site/checksite/$', views.checksite, name='checksite'),
    url(r'^site/updatesite/(?P<site>.+)/$', views.updatesite, name='updatesite'),
    url(r'^site/changename/$', views.sitechangename, name='sitechangename'),
